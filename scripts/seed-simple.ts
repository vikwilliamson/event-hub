// Simple seeding script that bypasses Firebase validation for testing
...
async function seedEvents() {
  ...
  try {
    // First create minimal organizer docs (bypassing validation for testing)
    console.log("📝 Creating minimal organizer documents...");
