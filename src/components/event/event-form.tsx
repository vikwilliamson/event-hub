    ...
    >
      ...
      <div>
        ...
        <Input
          ...
          {...register("title")}
        />
        {errors.title && <FieldError id="event-title-error">{errors.title.message}</FieldError>}
      </div>
      ...
      <div>
        <label htmlFor="event-location" className="block text-sm font-medium text-neutral-700">
          Location
        </label>
        <Input
          id="event-location"
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div>
          ...
          <Input
            ...
            {...register("date")}
          />
          {errors.date && <FieldError id="event-date-error">{errors.date.message}</FieldError>}
        </div>
        <div>
          ...
          <Input
            ...
            {...register("time")}
          />
          {errors.time && <FieldError id="event-time-error">{errors.time.message}</FieldError>}
        </div>
      </div>

      <div>
        <label htmlFor="event-capacity" className="block text-sm font-medium text-neutral-700">
        ...
        />
        {errors.capacity && <FieldError id="event-capacity-error">{errors.capacity.message}</FieldError>}
      </div>

      <div className="flex flex-wrap gap-3">
        <Button type="submit" isLoading={isPending} loadingLabel="Creating event">
          Publish event
        </Button>
        <Button
          type="button"
